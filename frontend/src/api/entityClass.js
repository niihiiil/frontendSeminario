...
class EntityClass {
  ...
  static async agregarUsuario(usuarioData) {
    try {
      const response = await axios.post('https://mte-api.onrender.com/api/user', usuarioData);
  ...
  static async cambiarContraseña(passwordData) {
    try {
      const response = await axios.post('https://mte-api.onrender.com/api/user/password', passwordData);
